    ...
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
      <div className="my-10 w-11/12 max-w-[700px] rounded-lg border border-slate-400 bg-slate-800">
        ...
        <div className="flex items-center justify-between rounded-t-lg bg-slate-700 p-5">
          <p className="text-xl font-semibold text-slate-50">Add Review</p>
          ...
          >
            ...
            <div className="flex w-11/12 flex-col space-y-2">
              ...
              <textarea
                ...
                className="form-style resize-x-none min-h-[130px] w-full shadow-sm shadow-white bg-gray-800 text-white bg-slate-600 placeholder-gray-500 rounded-md p-2"
              />
